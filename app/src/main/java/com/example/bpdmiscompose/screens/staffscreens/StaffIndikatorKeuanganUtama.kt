...
@Composable
fun StaffIndikatorKeuanganUtamaLayout (modifier: Modifier=Modifier, navController: NavHostController, indikatorKeuanganViewModel: IndikatorKeuanganViewModel, rbbViewModel: RBBViewModel)
{
    ...
    when(indikatorKeuanganUiState.indikatorKeuanganList){
        ...
        is Resources.Success ->{
            ...
            if(!hasRedirected.value){
                navController.navigate(BPDMISScreen.StaffIndikatorSearchResult.name)
